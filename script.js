document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            'projects.p3.d2': 'Structured Check-in Flow: Designed a "login → check-in → view records → leaderboard" closed loop to establish user operation habits.',
            'projects.p3.d3': 'Data Visualization Dashboard: Provided weekly/monthly check-in charts for both students and teachers, quantifying and visualizing the learning process to motivate students and assist teachers with targeted guidance.',
            'projects.p3.d4': 'Flexible Account System: Created a unique "one person, multiple children" (parent mode) and "multiple persons, one child" (collaborative mode) system to handle complex family scenarios and improve feature coverage.',
        ...
        zh: {
            ...
            'projects.p3.d2': '结构化打卡动线：设计"登录-打卡-查看记录-排行榜"闭环，固化用户操作心智。',
            'projects.p3.d3': '数据可视化看板：为学员与教师分别提供周/月打卡图表，将学习过程量化、可视化，激发学员攀比动力，辅助教师精准指导。',
            'projects.p3.d4': '灵活账户体系：独创"一人多娃"（家长端）与"多人一娃"（协作端）模式，适配复杂家庭场景，提升功能覆盖率。',
