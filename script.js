document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            'contact.intent_label': 'Intent',
            'contact.intent': 'Product Operations | User Operations | Content Strategy | Content Creation',
        ...
        zh: {
            ...
            'contact.intent_label': '意向方向',
            'contact.intent': '产品运营 | 用户运营 | 内容策略 | 内容创作',
